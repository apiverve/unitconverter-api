...
namespace APIVerve.Examples
{
    class UnitConverterExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/unitconverter";

        /// <summary>
        /// Make a GET request to the Unit Converter API
        /// </summary>
        static async Task<JsonDocument> CallUnitConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;value&quot;] &#x3D; 100, [&quot;from&quot;] &#x3D; &quot;lb&quot;, [&quot;to&quot;] &#x3D; &quot;kg&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Unit Converter API...\n");

            var result = await CallUnitConverterAPI();
