...
class unitconverterWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/unitconverter');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/unitconverter';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"value":{"type":"number","required":true},"from":{"type":"string","required":true},"to":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/unitconverter`);
        }
    }
...
module.exports = unitconverterWrapper;
