...
namespace APIVerve.API.UnitConverter
{
    ...
    /// <summary>
    /// Client for the UnitConverter API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/unitconverter";
        ...
        {
            { "value", new ValidationRule { Type = "number", Required = true } },
        ...
        public UnitConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnitConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnitConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnitConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UnitConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(UnitConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UnitConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnitConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnitConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnitConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnitConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnitConverterQueryOptions options)
        {
