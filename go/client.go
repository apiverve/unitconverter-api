...
const (
	baseURL        = "https://api.apiverve.com/v1/unitconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the Unit Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Unit Converter API client.
...
// Execute makes a request to the Unit Converter API with typed parameters.
//
