// Package unitconverter provides a Go client for the Unit Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/unitconverter?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Unit Converter API.
//
// Parameters:
//   - value (required): number - The value to convert
//   - from (required): string - The unit to convert from
//   - to (required): string - The unit to convert to
type Request struct {
...
// ResponseData contains the data returned by the Unit Converter API.
type ResponseData struct {
	Result ResultData `json:"result"`
	UnitDefinitions UnitDefinitionsData `json:"unitDefinitions"`
}

// ResultData represents the result object.
...
// UnitDefinitionsData represents the unitDefinitions object.
type UnitDefinitionsData struct {
