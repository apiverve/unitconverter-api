...
```gradle
dependencies {
    implementation 'com.github.apiverve:unitconverter-api:1.1.13'
}
```
...
```java
import com.apiverve.unitconverter.UnitConverterAPIClient;
import com.apiverve.unitconverter.APIResponse;
import com.apiverve.unitconverter.APIException;

// Initialize the client
UnitConverterAPIClient client = new UnitConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("value", 100);
    parameters.put("from", "lb");
    parameters.put("to", "kg");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/unitconverter](https://docs.apiverve.com/ref/unitconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/unitconverter](https://docs.apiverve.com/ref/unitconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/unitconverter-api/issues)
